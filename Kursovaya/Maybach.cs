...
namespace Kursovaya
{
    public partial class Maybach : Form
    {
        public Maybach()
        {
            InitializeComponent();
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM `maybach`", db.getConnection());
        ...
        private void buttonDoDelete_Click(object sender, EventArgs e)
        {
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM `maybach` WHERE `maybach`.`id` = @Nid", db.getConnection());
        ...
        private void Maybach_Load(object sender, EventArgs e)
        {
            panelDelete.Hide();
        }
